...
### emotion 을 사요해 보자
motion 라이브러리는 CSS-in-JS 라이브러리이며, React 컴포넌트의 스타일링을 쉽게 관리할 수 있도록 도와준다.
이 라이브러리는 JSX 문법을 사용하여 css를 적용할 수 있도록 지원합니다.
Emotion의 css 함수를 사용하면 JSX 요소에 직접 CSS 스타일을 적용할 수 있음!
...
이 함수는 템플릿 리터럴을 사용하여 CSS 스타일을 정의할 수 있도록 해줍니다.
