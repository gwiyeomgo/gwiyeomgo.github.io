---
title: Git Github Profile 로 깃험을 꾸미자
date: 2022-03-21
slug: "/git/2022-03-21-githubProfile"
tags:
   - GIT
   - 2022
---
...
아래와 같은 문구가 나타난다~
```
{닉네임}is a ✨special ✨ repository that you can use to add a README/ to your GitHub profile. Make sure it’s public and initialize it with a README to get started.
```
4. Public 으로 설정
5. Add a README file 도 추가 (개인 선택)

# 꾸미기
1. README/ 파일을 자유롭게 수정한다
